...
schedule.push({
    ...
    name    : "Daily Missions (+100 Orundum)",
...
schedule.push({
    ...
    name    : "Daily Trading Post (+? Orundum)",
...
schedule.push({
    ...
    name    : "Daily Supply Login (+1 Headhunting Permit)",
...
schedule.push({
    ...
    name    : "Weekly Mission (+500 Orundum)",
...
schedule.push({
    ...
    name    : "Weekly Reward Annihilation Operation (+1800 Orundum)",
...
schedule.push({
    ...
    name    : "Monthly Commendations Store Phase 1 (+2 Headhunting Permit)",
...
schedule.push({
    ...
    name    : "Monthly Commendations Store Phase 1 (+600 Orundum)",
...
schedule.push({
    ...
    name    : "Monthly Commendations Store Phase 2 (+2 Headhunting Permit)",
